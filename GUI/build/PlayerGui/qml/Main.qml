...
ApplicationWindow {
    ...
    Shortcut { sequence: "Up"; onActivated: playerBridge.setVolume(Math.min(1.0, playerBridge.volume + 0.05)) }
    Shortcut { sequence: "Down"; onActivated: playerBridge.setVolume(Math.max(0.0, playerBridge.volume - 0.05)) }
    Shortcut {
        sequence: "F"
        onActivated: {
            ...
            ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ControlButton {
                            ...
                            onClicked: {
                                ...
                                playerBridge.setPlaybackRate(next)
                            }
                        }
                    }
                }
                ...
                RowLayout {
                    ...
                    Slider {
                        ...
                        onMoved: playerBridge.setVolume(value)
                    }
